...
const [html,css,app,worker]=await Promise.all(["index.html","styles.css","app.js"].map(file=>readFile(join(src,file),"utf8")).concat(readFile(join(root,"worker","index.js"),"utf8")));
